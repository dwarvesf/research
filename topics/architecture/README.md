...
- [C4 diagrams](c4-diagrams.md) / [C4 modelling](c4-modelling.md)
...
- [Write-heavy scalable and reliable inventory platform](case-study-write-heavy-scalable-and-reliable-inventory-platform.md)
- [Design file sharing system: directory structure](design-file-sharing-system-part-1-directory-structure.md)
